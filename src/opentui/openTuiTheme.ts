...
export function getOpenTuiMarkdownSyntaxStyle(): SyntaxStyle {
  if (!markdownSyntaxStyle) {
    markdownSyntaxStyle = SyntaxStyle.fromStyles({
      ...
      // Used by the renderer as the fallback color for concealed markers
      // (heading `#`, blockquote/hr borders) — keep this subdued so it
      // reads as structure rather than content.
      conceal: { fg: openTuiTheme.color.textFaint },
      markup: { fg: openTuiTheme.color.text },
      'markup.heading': { fg: openTuiTheme.color.amber, bold: true },
      'markup.heading.1': { fg: openTuiTheme.color.cyanStrong, bold: true, underline: true },
      'markup.heading.2': { fg: openTuiTheme.color.amber, bold: true, underline: true },
      'markup.heading.3': { fg: openTuiTheme.color.amber, bold: true },
      'markup.heading.4': { fg: openTuiTheme.color.amberSoft, bold: true },
      'markup.heading.5': { fg: openTuiTheme.color.amberSoft, bold: true },
      'markup.heading.6': { fg: openTuiTheme.color.amberSoft, bold: true },
      ...
      'markup.raw.block': { fg: openTuiTheme.color.textSoft },
      'markup.quote': { fg: openTuiTheme.color.textMuted, italic: true },
      ...
      'markup.link.url': { fg: openTuiTheme.color.green, underline: true },
      'markup.link.bracket.close': { fg: openTuiTheme.color.cyanStrong },
      label: { fg: openTuiTheme.color.textFaint, italic: true },
      'character.special': { fg: openTuiTheme.color.textSoft },
      punctuation: { fg: openTuiTheme.color.ghost },
      'punctuation.delimiter': { fg: openTuiTheme.color.ghost },
      'punctuation.special': { fg: openTuiTheme.color.ghost },
      keyword: { fg: openTuiTheme.color.violet },
      'keyword.directive': { fg: openTuiTheme.color.violet, italic: true },
